...
theta = bayes_sl_ricker_wood(y,1,500000,n,cov_rw);  % NOTE: this will take many hours to run (reduce number of iterations if desired)
...
n = 50; % change the value of n as desired
%parpool(16); % for parallel computing
theta = bayes_sl_ricker_wood_go(y,1,500000,n,cov_rw); % NOTE: this will take many hours to run (reduce number of iterations if desired)
%delete(gcp); % also for parallel computing
...
tol = 10; %change the value of tol as desired
[theta, dists, summ_stats] = abc_ricker_wood(y,1,25000000,theta_curr,tol,cov_abc,cov_rw); % NOTE: this will take many hours to run (reduce number of iterations if desired)
