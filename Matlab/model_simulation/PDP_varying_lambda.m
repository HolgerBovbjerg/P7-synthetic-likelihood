...
for i = 1:steps
    plot(t,pow2db(P_y_simulated(:,i)),'DisplayName', "T= " + Tvals(i))
    hold on
end
legend
...
for i = 1:steps
    plot(t,pow2db(P_y_simulated(:,i)),'DisplayName', "G_0 = " + G0vals(i))
    hold on
end
legend
...
for i = 1:steps
    plot(t,pow2db(P_y_simulated(:,i)),'DisplayName', "\lambda = " + lambdavals(i))
    hold on
end
legend
...
for i = 1:steps
    plot(t,pow2db(P_y_simulated(:,i)),'DisplayName', "\sigma_N^2 = " + sigma_N_square_vals(i))
    hold on
end
legend